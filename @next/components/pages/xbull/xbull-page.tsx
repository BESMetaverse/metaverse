...
export const xBullPage = ({ props }: xBullProps): JSX.Element => {
  ...
  const connect = async () => {
    ...
    console.log('server is ', server, activeChain, address)
    if (!server) {
      console.log('No server')
    } else {
      try {
        // console.log('trying')
        // console.log('account number is *', publicKeys)

        // const account = await server.getAccount(publicKeys)
        // // console.log('account number is *', account, publicKeys)
        // console.log('account number is *', publicKeys)

        // const sequence = account.sequenceNumber()
        // // // const sequence = '448184132305108'
        ...
        // // console.log('source and public key is *', source, ' and ', publicKeys)
        ...
        // })
        // console.log('transaction is ', transaction.toXDR())
        // // let txn = transaction.toXDR();
        // let txn = await server.prepareTransaction(
        //   transaction,
        ...
        // freighter wallet mint code below
        // console.log(hash)
        // const timeout = 60000
  ...
  return (
    <>
      <div style={centerButtonStyles}>
        ...
        <button onClick={connect}>Send Transaction</button>
      </div>
    </>
  )
}
